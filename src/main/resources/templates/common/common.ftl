...
<#macro page>
    ...
    <div class="w3-container w3-center">
        <div class="w3-bar w3-padding-large w3-padding-24">
            <button class="w3-btn w3-hover-yellow w3-round-large" onclick="location.href='/main'">Main Page</button>
            ...
            <button class="w3-btn w3-hover-gray w3-round-large" onclick="location.href='/registry/insert'">Registry</button>
        </div>
    </div>
    <#nested>
    </body>
